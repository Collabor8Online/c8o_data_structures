    ...
    RSpec.describe DecimalField do
      ...
      describe ".new" do
        it "sets the default value" do
          expect(described_class.new(caption: "How many fingers am I holding up?", default: 4.0).default).to eq 4.0
        end

        it "sets the minimum value" do
          expect(described_class.new(caption: "How many fingers am I holding up?", minimum: 0.0).minimum).to eq 0.0
        end

        it "sets the maximum value" do
          expect(described_class.new(caption: "How many fingers am I holding up?", maximum: 10.0).maximum).to eq 10.0
        end
      end
