...
RSpec.describe "DSL" do
  ...
  it "defines a simple template" do
    template = DataStructures["examples"].load simple_template
  ...
  it "defines a template with a repeating group" do
    template = DataStructures["examples"].load order_form
  ...
  it "defines a template with sections and static content" do
    template = DataStructures["examples"].load fancy_order_form
